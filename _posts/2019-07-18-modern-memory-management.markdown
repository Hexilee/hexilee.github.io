---
layout:     post
title:      "现代化的内存管理：Cpp vs Rust"
subtitle:   "Which is safer?"
...
[本文代码地址](https://github.com/Hexilee/modern-memory-management)
...
对 Rust 线程安全有兴趣的读者可以自行参阅官方文档，本文也无法讨论太多了；有一定 Rust 基础的读者还可以看看这篇文章作为拓展阅读[《如何理解 rust 中的 Sync、Send？》](https://hexilee.me/2019/05/05/how-to-understand-sync-and-send-in-rust/)。
